import { getProductPercentageSukosari } from '@/lib/queries/production-progress-protrack';
...
export async function GET(req: Request) {
  try {
    ...
    const data = await getProductPercentageSukosari(workshop, project, trainset);
