...
export default async function SukosariPage({ searchParams }: { searchParams: Promise<{ [k: string]: string | string[] | undefined }> }) {
  const resolvedSearchParams = await searchParams;
  const lineLabel = "Worskshop";
  const workshop = "Sukosari";
  ...
  try {
    ...
    console.error('[SukosariPage] Failed to fetch initial data:', error);
  }
