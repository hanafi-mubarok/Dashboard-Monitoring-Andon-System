...
export default function ProductSummaryListLantai1({ trainset, project }: ProductSummaryListLantai1Props) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`/api/product/summary-lantai1?${params.toString()}`);
